...
<body>
    <div id="full">
        ...
        <div id="middle">
            <a href="A_Register.php" style="text-decoration: none"><div id="select-box">Artist</div></a>
            <a href="C_Register.php" style="text-decoration: none"><div id="select-box">Client</div></a>
        </div>
    </div>
